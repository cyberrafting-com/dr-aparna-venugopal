...
<link href="{{ asset('resources/assets/css/swiper.css') }}" rel="stylesheet" type="text/css" >
<link href="{{ asset('resources/assets/css/style.css') }}" rel="stylesheet" type="text/css" >
<link href="{{ asset('resources/assets/css/coloring.css') }}" rel="stylesheet" type="text/css" >
<!-- color scheme -->
<link id="colors" href="{{ asset('resources/assets/css/colors/scheme-01.css') }}" rel="stylesheet" type="text/css" >
