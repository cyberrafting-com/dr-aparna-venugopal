...
Route::get('/services/laparoscopic-gall-bladder-surgery', function () {
...
Route::get('/services/breast-lump-evaluation-surgery', function () {
...
Route::get('/services/pilonidal-sinus-surgery', function () {
...
Route::get('/services/lipoma-sebaceous-cyst-removal', function () {
